...
[_QWERTY] = LAYOUT( \
      KC_A,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                 KC_5,    KC_4,    KC_3,    KC_2,    KC_1,    KC_A, \
      KC_B,  KC_6,    KC_7,    KC_8,    KC_9,    KC_0,                 KC_0,    KC_9,    KC_8,    KC_7,    KC_6,    KC_B, \
      KC_C,  KC_K,    KC_L,    KC_M,    KC_N,    KC_O,                 KC_O,    KC_N,    KC_M,    KC_L,    KC_K,    KC_C , \
      KC_D,  KC_E,    KC_F,    KC_G,    KC_H,    KC_I,   KC_J,  KC_J,  KC_I,    KC_H,    KC_G,    KC_F,    KC_E,    KC_D \
      ),
  /* Colemak
   * ,-----------------------------------------.             ,-----------------------------------------.
