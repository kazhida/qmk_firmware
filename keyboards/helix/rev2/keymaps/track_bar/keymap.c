...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_EUCALYN] = LAYOUT( \
      ...
      SFT_TAB,  KC_A,   KC_S,   KC_D,   KC_F,     KC_G,                      KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, \
      SFT_TAB,  KC_A,   KC_S,   KC_D,   KC_F,     KC_G,     RAISE,  KC_RBRC,  KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, \
      KC_OPT,   CMD_Z,  KC_X,   KC_C,   RAISE_V,  LOWER_B,  LOWER,  KC_SPC,   RAISE,   KANA,    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
  ...
  [_LOWER] = LAYOUT( \
      _______,  KC_1,     KC_2,     KC_3,     KC_4,     KC_5,                       KC_LALT,  KC_LSFT,  KC_LGUI,  KC_MINS,  KC_6,     KC_1, \
      _______,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,                       KC_LEFT,  KC_RCTL,  KC_LBRC,  KC_EQL,   KC_7,     KC_2, \
      _______,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,                       KC_DOWN,  KC_UP,    KC_RBRC,  KC_QUOT,  KC_8,     KC_3, \
      _______,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     _______,  RAISE,  KC_RGHT,  KC_RCTL,  KANA,     KC_GRV,   KC_9,     KC_4, \
      _______,  _______,  _______,  _______,  _______,  _______,  _______,  LOWER,  KC_RALT,  KC_RSFT,  KC_RGUI,  KC_ENT,   KC_0,     KC_5  \
      ),
  ...
  [_RAISE] = LAYOUT( \
      _______,  KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,                  KC_LALT,  KC_LSFT,  KC_LGUI,  KC_MINS,  KC_6,     KC_1, \
      _______,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,                  KC_LEFT,  KC_RCTL,  KC_LBRC,  KC_EQL,   KC_7,     KC_2, \
      _______,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,                  KC_DOWN,  KC_UP,    KC_RBRC,  KC_QUOT,  KC_8,     KC_3, \
      _______,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     RAISE,  RAISE,  KC_RGHT,  KC_RCTL,  KANA,     KC_GRV,   KC_9,     KC_4, \
      _______,  _______,  _______,  _______,  _______,  _______,  LOWER,  LOWER,  KC_RALT,  KC_RSFT,  KC_RGUI,  KC_ENT,   KC_0,     KC_5  \
      ),
