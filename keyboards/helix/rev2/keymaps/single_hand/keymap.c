...
#define CMD_Y     LALT_T(KC_Y)
#define CMD_P     RALT_T(KC_P)
#define OPT_N     LGUI_T(KC_N)
#define OPT_SLSH  RGUI_T(KC_SLSH)
#define CNTL_J    LCTL_T(KC_J)
#define CNTL_L    RCTL_T(KC_L)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
  [_SINGLE] = LAYOUT( \
      KC_Q,     KC_A,     KC_Z,     CMD_Y,    SFT_H,    OPT_N,                    OPT_N,    SFT_H,    CMD_Y,    KC_Z,     KC_A,     KC_Q,  \
      KC_W,     KC_S,     KC_X,     KC_U,     CNTL_J,   KC_M,                     KC_M,     CNTL_J,   KC_U,     KC_X,     KC_S,     KC_W,  \
      KC_E,     KC_D,     KC_C,     KC_I,     KC_K,     KC_COMM,                  KC_COMM,  KC_K,     KC_I,     KC_C,     KC_D,     KC_E,  \
      KC_R,     KC_F,     KC_V,     KC_O,     CNTL_L,   KC_DOT,   RAISE,  RAISE,  KC_DOT,   CNTL_L,   KC_O,     KC_V,     KC_F,     KC_R,  \
      KC_T,     KC_G,     KC_B,     CMD_P,    SFT_SCLN, OPT_SLSH, LOWER,  LOWER,  OPT_SLSH, SFT_SCLN, CMD_P,    KC_B,     KC_G,     KC_T   \
      ),
  ...
  [_ADJUST] =  LAYOUT( \
      ...
      _______,  _______,  _______,  QWERTY,   DVORAK,   SINGLE,                      SINGLE,  DVORAK,   QWERTY,  _______,  _______,  _______,  \
...
#endif
        persistent_default_layer_set(1UL<<_SINGLE);
      }
      return false;
    case DVORAK:
      if (record->event.pressed) {
